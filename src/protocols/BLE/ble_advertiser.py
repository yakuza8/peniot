...
# Here, we continiously advertise ourselves to hook a naive listener which does not have a white list. However, we will implement what 
# will happen when we trick a naive scanner later